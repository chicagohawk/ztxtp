...
void MyTraderSpi::OnTradeEvent(XTPTradeReport *trade_info, uint64_t session_id)
{
	...
	cout << "Order_Client_ID:" << pTrade->order_client_id << endl;
	cout << "Local_Order_ID:" << pTrade->local_order_id << endl;
	cout << "Order_Exch_ID:" << pTrade->order_exch_id << endl;
	cout << "Order_xtp_id:" << pTrade->order_xtp_id << endl;
	cout << "Side:" << pTrade->side << endl;
	cout << "Price:" << pTrade->price << endl;
	cout << "Quantity:" << pTrade->quantity << endl;
	cout << "Trade amount" << pTrade->trade_amount << endl;
	cout << "Trade Time:" << pTrade->trade_time << endl;
	cout << "Report Index:" << pTrade->report_index << endl;
#endif
